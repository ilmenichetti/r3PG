---
title: "The r3PGq R package"
author: "Francesco Minunno and Lorenzo Menichetti over the original package by Volodymyr Trotsiuk, Florian Hartig, David I. Forrester"
date: "`r Sys.Date()`"
abstract: "This vignette provides an overview of the r3PGq R package functions and options. The package is a modification of the original r3PG package, to which a decomposition model (Q) coupled with the grouwth model was added. We provide, besides the originial working examples for the r3PG package demonstrating the basic functionality and use of the package, additional examples to demonstrate the added functionalities  \n \n \n"
output: 
  rmarkdown::html_vignette:
    toc: true
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{Vignette for the r3PGq R package}
...
The package is a modification of the original `r3PG` package, with an added module for organic matter decomposition to allow the model to simulate the full C balance of a tree community.
...
## The Q decomposition model
The Q decomposition model is a generalization of the structure of compartmental first-order kinetic decomposition models. Instead of describing the decomposing material as a series of interconnected "pools" each with its own decomposition kinetic related to its characteristics, describes the full mass of decomposing organic matter with a continuous distribution function of its quality. This approach has been defined as  "continuous quality theory" in its original formulation (Ågren and Bosatta, 1996).
The Q model is used here to follow the decomposition of four different organic matter sources represented by 3PG: leaves, roots, stems and branches, and it is run separately for each of these sources.



# The `r3PG` model to simulate the growth of forest stands
The growth model can be run alone
...
# The `r3PGq` model to simulate the evolution of C stocks and growth of forest stands
...
* Ågren, G. I., Bosatta, E., 1996. Quality: A Bridge between Theory and Experiment in Soil Organic Matter Studies. Oikos 76, 522. https://doi.org/10.2307/3546345
